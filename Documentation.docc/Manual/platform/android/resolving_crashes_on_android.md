...
1. In the left menu, navigate to `Test and release > Latest releases and bundles`.

@Image(source: "play_console_latest_release_bundles.png")

1. Now choose the relevant bundle and open it.

@Image(source: "play_console_latest_release_bundles2.png")

1. Select the `Downloads` tab, and scroll down to the `Assets` section.

@Image(source: "play_console_app_bundle_explorer.png")

1. Next to `Native debug symbols`, click the upload arrow icon.

@Image(source: "play_console_app_bundle_explorer2.png")

1. Select and upload the corresponding native debug symbols file for that build version.

@Image(source: "play_console_upload_native_debug_symbols.png")
...
@Image(source: "play_console_create_new_release.png")

1. Click the three-dot menu beside it.

1. Choose `Upload native debug symbols (.zip)` from the menu.

@Image(source: "play_console_create_new_release2.png")
...
1. Save your crash log to a text file (for example, `crash.txt`).
