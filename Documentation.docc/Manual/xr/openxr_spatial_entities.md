...
@Image(source: "openxr_spatial_entities_project_settings.png")
...
[OpenXRSpatialEntityTracker](https://docs.godotengine.org/en/stable/classes/class_openxrspatialentitytracker.html#class-openxrspatialentitytracker)
object is instantiated and registered with the [XRServer](https://docs.godotengine.org/en/stable/classes/class_xrserver.html#class-xrserver).
...
As the tracker objects can be used with [XRAnchor3D](https://docs.godotengine.org/en/stable/classes/class_xranchor3d.html#class-xranchor3d) nodes, these subscenes
...
object. As all locations are local to the [XROrigin3D](https://docs.godotengine.org/en/stable/classes/class_xrorigin3d.html#class-xrorigin3d) node, we should create
...
Spatial anchors are tracked using [OpenXRAnchorTracker](https://docs.godotengine.org/en/stable/classes/class_openxranchortracker.html#class-openxranchortracker) objects
registered with the XRServer.

When needed, the location of the spatial anchor will be updated automatically; the pose on the
related tracker will be updated and thus the [XRAnchor3D](https://docs.godotengine.org/en/stable/classes/class_xranchor3d.html#class-xranchor3d) node will
reposition.
...
This scene should have an [XRAnchor3D](https://docs.godotengine.org/en/stable/classes/class_xranchor3d.html#class-xranchor3d) node as the root but nothing
...
The root node for this scene must be an [XRAnchor3D](https://docs.godotengine.org/en/stable/classes/class_xranchor3d.html#class-xranchor3d) node.
We'll add a [StaticBody3D](https://docs.godotengine.org/en/stable/classes/class_staticbody3d.html#class-staticbody3d) node as a child and add a
[CollisionShape3D](https://docs.godotengine.org/en/stable/classes/class_collisionshape3d.html#class-collisionshape3d) and [MeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_meshinstance3d.html#class-meshinstance3d)
node as children of the static body.

@Image(source: "openxr_plane_anchor.png")
...
For our "hole punch" material, create a [ShaderMaterial](https://docs.godotengine.org/en/stable/classes/class_shadermaterial.html#class-shadermaterial)
...
Please consult the [OpenXRPlaneTracker](https://docs.godotengine.org/en/stable/classes/class_openxrplanetracker.html#class-openxrplanetracker) class documentation for
further information.
...
When markers are detected, [OpenXRMarkerTracker](https://docs.godotengine.org/en/stable/classes/class_openxrmarkertracker.html#class-openxrmarkertracker) objects are
...
with an [XRAnchor3D](https://docs.godotengine.org/en/stable/classes/class_xranchor3d.html#class-xranchor3d) node at the root, save this, and assign it to the
...
[OpenXRSpatialEntityExtension](https://docs.godotengine.org/en/stable/classes/class_openxrspatialentityextension.html#class-openxrspatialentityextension) singleton.
...
entry and that is [OpenXRSpatialQueryResultData](https://docs.godotengine.org/en/stable/classes/class_openxrspatialqueryresultdata.html#class-openxrspatialqueryresultdata).
...
[OpenXRSpatialEntityTracker](https://docs.godotengine.org/en/stable/classes/class_openxrspatialentitytracker.html#class-openxrspatialentitytracker) instance is destroyed.

### Spatial anchor capability

Spatial anchors are managed by our [OpenXRSpatialAnchorCapability](https://docs.godotengine.org/en/stable/classes/class_openxrspatialanchorcapability.html#class-openxrspatialanchorcapability)
singleton object.
...
[OpenXRSpatialCapabilityConfigurationAnchor](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcapabilityconfigurationanchor.html#class-openxrspatialcapabilityconfigurationanchor)
...
for the same user and app (using`persist_anchor`and`unpersist_anchor`functions)
...
--------- | ---------- | -----------
COMPONENT_TYPE_ANCHOR | [OpenXRSpatialComponentAnchorList](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcomponentanchorlist.html#class-openxrspatialcomponentanchorlist) | Provides us with the pose (location + orientation) of each anchor
COMPONENT_TYPE_PERSISTENCE | [OpenXRSpatialComponentPersistenceList](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcomponentpersistencelist.html#class-openxrspatialcomponentpersistencelist) | Provides us with the persistence state and UUID of each anchor
...
Finally we can process our snapshot. Note that we are using [OpenXRAnchorTracker](https://docs.godotengine.org/en/stable/classes/class_openxranchortracker.html#class-openxranchortracker)
...
[OpenXRSpatialPlaneTrackingCapability](https://docs.godotengine.org/en/stable/classes/class_openxrspatialplanetrackingcapability.html#class-openxrspatialplanetrackingcapability)
singleton class.
...
Component | Data class | Description
--------- | ---------- | -----------
COMPONENT_TYPE_BOUNDED_2D | [OpenXRSpatialComponentBounded2DList](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcomponentbounded2dlist.html#class-openxrspatialcomponentbounded2dlist) | Provides us with the center pose and bounding rectangle for each plane.
COMPONENT_TYPE_PLANE_ALIGNMENT | [OpenXRSpatialComponentPlaneAlignmentList](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcomponentplanealignmentlist.html#class-openxrspatialcomponentplanealignmentlist) | Provides us with the alignment of each plane
COMPONENT_TYPE_MESH_2D | [OpenXRSpatialComponentMesh2DList](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcomponentmesh2dlist.html#class-openxrspatialcomponentmesh2dlist) | Provides us with a 2D mesh that shapes each plane
COMPONENT_TYPE_POLYGON_2D | [OpenXRSpatialComponentPolygon2DList](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcomponentpolygon2dlist.html#class-openxrspatialcomponentpolygon2dlist) | Provides us with a 2D polygon that shapes each plane
COMPONENT_TYPE_PLANE_SEMANTIC_LABEL | [OpenXRSpatialComponentPlaneSemanticLabelList](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcomponentplanesemanticlabellist.html#class-openxrspatialcomponentplanesemanticlabellist) | Provides us with a type identification of each plane
...
We can use our [OpenXRPlaneTracker](https://docs.godotengine.org/en/stable/classes/class_openxrplanetracker.html#class-openxrplanetracker) tracker object to store our component data.
...
[OpenXRSpatialMarkerTrackingCapability](https://docs.godotengine.org/en/stable/classes/class_openxrspatialmarkertrackingcapability.html#class-openxrspatialmarkertrackingcapability)
singleton class.
...
------ | ----------------- | --------------------
April tag | `april_tag_is_supported` | [OpenXRSpatialCapabilityConfigurationAprilTag](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcapabilityconfigurationapriltag.html#class-openxrspatialcapabilityconfigurationapriltag)
Aruco | `aruco_is_supported` | [OpenXRSpatialCapabilityConfigurationAruco](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcapabilityconfigurationaruco.html#class-openxrspatialcapabilityconfigurationaruco)
QR code | `qrcode_is_supported` | [OpenXRSpatialCapabilityConfigurationQrCode](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcapabilityconfigurationqrcode.html#class-openxrspatialcapabilityconfigurationqrcode)
Micro QR code | `micro_qrcode_is_supported` | [OpenXRSpatialCapabilityConfigurationMicroQrCode](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcapabilityconfigurationmicroqrcode.html#class-openxrspatialcapabilityconfigurationmicroqrcode)
...
Component | Data class | Description
--------- | ---------- | -----------
COMPONENT_TYPE_MARKER | [OpenXRSpatialComponentMarkerList](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcomponentmarkerlist.html#class-openxrspatialcomponentmarkerlist) | Provides us with the type, ID (Aruco and April Tag), and/or data (QR Code) for each marker.
COMPONENT_TYPE_BOUNDED_2D | [OpenXRSpatialComponentBounded2DList](https://docs.godotengine.org/en/stable/classes/class_openxrspatialcomponentbounded2dlist.html#class-openxrspatialcomponentbounded2dlist) | Provides us with the center pose and bounding rectangle for each plane.
