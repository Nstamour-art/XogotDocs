...
which is the database that contains all the [object](https://docs.godotengine.org/en/stable/classes/class_object.html#class-object)-derived classes
...
> Seealso:
>
> See <doc:node_alternatives> for information on using lighter-weight
...
@Image(source: "objectdb_profiler_summary_no_snapshots.png", alt: "ObjectDB profiler summary with no snapshots taken") {ObjectDB profiler summary with no snapshots taken}
...
@Image(source: "objectdb_profiler_summary_snapshot.png", alt: "ObjectDB profiler summary with one snapshot taken") {ObjectDB profiler summary with one snapshot taken}
...
> `user://objectdb_snapshots/` (see <doc:data_paths#Accessing-Persistent-User-Data>
...
@Image(source: "objectdb_profiler_summary_diff_against.png", alt: "Diff Against dropdown in the bottom-left corner of the ObjectDB profiler") {Diff Against dropdown in the bottom-left corner of the ObjectDB profiler}

The summary page will then show the differences between the two snapshots:

@Image(source: "objectdb_profiler_summary_snapshot_diff.png", alt: "Two snapshots being compared in the Summary tab") {Two snapshots being compared in the Summary tab}
...
@Image(source: "objectdb_profiler_classes.png", alt: "One snapshots being viewed in the Classes tab") {One snapshots being viewed in the Classes tab}
...
@Image(source: "objectdb_profiler_classes_diff.png", alt: "Two snapshots being compared in the Classes tab. Here, column A is `second_session`, column B is `first_session`") {Two snapshots being compared in the Classes tab. Here, column A is `second_session`, column B is `first_session`}

You can click on a class in the list on the right to view it in the inspector.

@Image(source: "objectdb_profiler_classes_inspector.png", alt: "A selected class instance being viewed in the inspector") {A selected class instance being viewed in the inspector}
...
@Image(source: "objectdb_profiler_objects_top_down.png", alt: "The Objects tab being used to view objects in a "top-down" manner") {The Objects tab being used to view objects in a "top-down" manner}
...
@Image(source: "objectdb_profiler_objects_bottom_up.png", alt: "The Objects tab being used to view objects in a "bottom-up" manner") {The Objects tab being used to view objects in a "bottom-up" manner}

### Nodes

Next, the Nodes tab shows the scene tree at the time the snapshot was taken.

@Image(source: "objectdb_profiler_nodes.png", alt: "The Nodes tab being used to view the scene tree") {The Nodes tab being used to view the scene tree}
...
@Image(source: "objectdb_profiler_nodes_diff_separate.png", alt: "Separate diff view in the Nodes tab") {Separate diff view in the Nodes tab}
...
@Image(source: "objectdb_profiler_nodes_diff_combined.png", alt: "Combined diff view in the Nodes tab") {Combined diff view in the Nodes tab}
...
@Image(source: "objectdb_profiler_nodes_orphan.png", alt: "Orphan nodes at the end of the nodes tree in the ObjectDB profiler") {Orphan nodes at the end of the nodes tree in the ObjectDB profiler}

### RefCounted

The last tab is the RefCounted tab. This tab is similar to the Objects
tab, but it shows the reference counts of [refcounted](https://docs.godotengine.org/en/stable/classes/class_refcounted.html#class-refcounted)-derived
...
@Image(source: "objectdb_profiler_refcounted.png", alt: "The RefCounted tab being used to view RefCounted instances") {The RefCounted tab being used to view RefCounted instances}

> Note:
>
> The RefCounted tab does **not** list objects that derive directly from
> [object](https://docs.godotengine.org/en/stable/classes/class_object.html#class-object), as these don't use reference counting.