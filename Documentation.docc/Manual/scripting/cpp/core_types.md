...
This means that, in general, you can use the <doc:index> section to learn how to
...
Please refer to <doc:common_engine_methods_and_macros> for information on this. The functions and macros documented
there are also available in godot-cpp.

## Core types

Godot's <doc:core_types> are also available in godot-cpp, and the same recommendations apply
...
Please refer to <doc:variant_class> to learn about how to work with `Variant`.
...
Please refer to <doc:object_class> to learn how to register and work with your own `Object` types.
