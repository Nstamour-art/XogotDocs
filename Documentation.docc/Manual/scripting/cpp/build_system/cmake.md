...
> Godot instead, see <doc:introduction_to_the_buildsystem>.
>

Beside the SCons based build system, godot-cpp also provides a CMakeLists.txt
file to support users that prefer using CMake over SCons for their build
system.
...
So long as CMake is installed from the CMake Downloads page and in the PATH,
