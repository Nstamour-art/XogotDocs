...
[itch.io](https://itch.io) is a popular platform for distributing indie games, including browser-based games exported from Xogot. Here's how to upload your game:

1. **Create an itch.io account**, if you don’t already have one.
2. On itch.io, click **Upload new project**.
3. Enter basic information about your game:
   * Title
   * Project URL
4. In the **Kind of project** section, select **HTML**.
5. Upload the zip file you downloaded from Xogot, following the instructions from the 
section above.
6. Ensure the **"This file will be played in the browser"** option is checked.
7. Optionally configure your game's display settings, such as viewport size or fullscreen behavior.
8. (Optional) Fill in other details about your project:
    * Short description or tagline (optional)
    * Description (including screenshots or cover art)
    * Tags and genre
9. Set the visibility of your game to **Draft** or **Public** depending on whether you're ready to release.
10. Click **Save & View Page** to preview your game page.
11. Once you're happy with everything, click **Publish** to make your game available to others.

Your game is now live and fully playable in the browser via itch.io!

@Image(source: itch_loading.png)
